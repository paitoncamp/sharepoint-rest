...
INSERT INTO `config` (`id`, `name`, `value`, `notes`) VALUES
	(1, 'sp_site_name', 'Example Dev', '0'),
	(2, 'sp_site_path', '/sites/ExampleDev', 'sub sites path only'),
	(3, 'client_id', '4b6a-a258-a04ff57e', 'sharepoint sites app principals\r\nhttps://example.sharepoint.com/sites/PaitonDev/_layouts/15/appprincipals.aspx\r\nto create :\r\nhttps://paitonoperation.sharepoint.com/sites/PaitonDev/_layouts/15/appregnew.aspx\r\n '),
	(4, 'client_secret', '3V33BQ3XhvcyW6EaH4=', '0'),
	(5, 'app_domain', 'example.localhost', '0'),
	(6, 'redirect_uri', 'https://example.localhost', '0'),
	...
	(13, 'sp_site', 'example.sharepoint.com', 'main sharepoint site name');
